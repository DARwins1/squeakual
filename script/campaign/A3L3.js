...
function sendInfestedGroup()
{
	...
	case 2: // Travel from entrances 4 -> 2
		...
		droids = camRandInfTemplates(
			// Cyborgs and Bashers
			[cTempl.basher, cTempl.infcybhg, cTempl.infcybgr, cTempl.infcybca, cTempl.infcybhg], 
			4 + camRand(5), // 4 - 8 core units
			14 + camRand(3) // 14 - 16 fodder
		);
		break;
...
function eventStartLevel()
{
	...
	camSetFactories({
		...
		"infCybFactory": {
			...
			templates: [ cTempl.infcybca, cTempl.infcybgr, cTempl.infcybhg, cTempl.infcybfl ]
		},
	});
